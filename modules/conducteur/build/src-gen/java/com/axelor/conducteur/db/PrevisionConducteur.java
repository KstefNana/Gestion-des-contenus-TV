...
@DynamicUpdate
@Table(
  name = "CONDUCTEUR_PREVISION_CONDUCTEUR",
  indexes = {
    @Index(
...
public class PrevisionConducteur extends AuditableModel {

  @Id
  @GeneratedValue(
    strategy = GenerationType.SEQUENCE,
    generator = "CONDUCTEUR_PREVISION_CONDUCTEUR_SEQ"
  )
  @SequenceGenerator(
    name = "CONDUCTEUR_PREVISION_CONDUCTEUR_SEQ",
    sequenceName = "CONDUCTEUR_PREVISION_CONDUCTEUR_SEQ",
    allocationSize = 1
  )
  private Long id;
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PrevisionConducteur)) return false;

    final PrevisionConducteur other = (PrevisionConducteur) obj;
